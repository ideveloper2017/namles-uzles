        ...
        _refreshValue: function () {
            ...
            if (this.options.values && this.options.values.length)this.handles.each(function (h) {
                ...
                if (c.options.range === true)if (c.orientation === "horizontal") {
                    ...
                    if (h === 1)c.range[f ? "animate" : "css"]({width: e - g + "%"}, {
                        queue: false,
                        duration: a.animate
                    })
                } else {
                ...
                if (b === "max" && this.orientation === "horizontal")this.range[f ? "animate" : "css"]({width: 100 - e + "%"}, {
                    queue: false,
                    duration: a.animate
                });
                if (b === "min" && this.orientation === "vertical")this.range.stop(1, 1)[f ? "animate" : "css"]({height: e + "%"}, a.animate);
                if (b === "max" && this.orientation === "vertical")this.range[f ? "animate" : "css"]({height: 100 - e + "%"}, {
                    queue: false,
                    duration: a.animate
                })
            }
