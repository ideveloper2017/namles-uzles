...
<head>
    ...
    <link href="<?php echo THEMEURL; ?>/css/master.css" rel="stylesheet">

    <!-- SWITCHER -->
    <link rel="stylesheet" id="switcher-css" type="text/css" href="<?php echo THEMEURL; ?>/plugins/switcher/css/switcher.css" media="all" />
    <link rel="alternate stylesheet" type="text/css" href="<?php echo THEMEURL; ?>/plugins/switcher/css/color1.css" title="color1" media="all" />
    <link rel="alternate stylesheet" type="text/css" href="<?php echo THEMEURL; ?>/plugins/switcher/css/color2.css" title="color2" media="all" />
    <link rel="alternate stylesheet" type="text/css" href="<?php echo THEMEURL; ?>/plugins/switcher/css/color3.css" title="color3" media="all" />
    <link rel="alternate stylesheet" type="text/css" href="<?php echo THEMEURL; ?>/plugins/switcher/css/color4.css" title="color4" media="all" />

    <script src="<?php echo THEMEURL; ?>/js/jquery-1.11.2.min.js"></script>
        ...
        <div class="header-top">
            <div class="wrapper">
                <div class="col-lg-9 col-md-9 col-sm-9 col-xs-12">
                    <div class="header-info">
                        <div class="description-header">
                            Welcome to Garden Master . Premium Garden Services
                        </div>
                ...
                <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                    <a href="." class="btn extra-color text-uppercase pull-right">Get Free Quote</a>
                </div>
            </div>
        </div>
                ...
                <div class="col-lg-8 col-md-8 col-sm-7 col-xs-12 nav-box">
                    ...
                    <nav class="nav-container">
                        <ul>
                            ...
                            <li>
                                <a class="#" href="home-1.html">Home</a>
                                <ul class="submenu">
                                    <li>
                            ...
                            <li><a class="#" href="#">Our Works</a></li>
                            <li><a class="#" href="shop-1.html">Store</a></li>
                            <li><a class="#" href="blog.html">Blog</a></li>
                            <li><a class="#" href="contact-1.html">Contact</a></li>
                        </ul>
                    </nav>
                </div>
    ...
    <div id="owl-home" class="owl-carousel owl-theme home-slider">
        ...
        <div class="item">
            <div class="h-slider-bg">
                <img class="slide-bg" src="<?php echo THEMEURL; ?>/media/home-slider/slide-1.jpg" alt="slide-1">
            </div>
        ...
        <div class="item">
            <div class="h-slider-bg">
                <img class="slide-bg" src="<?php echo THEMEURL; ?>/media/home-slider/slide-2.jpg" alt="slide-2">
            </div>
            <div class="wrapper">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
        ...
        <div class="item">
            <div class="h-slider-bg">
                <img class="slide-bg" src="<?php echo THEMEURL; ?>/media/home-slider/slide-3.jpg" alt="slide-3">
            </div>
                    ...
                    <div class="c-link-box wow rollIn">
                        <a class="btn big-circle pull-right" href="#">
									<span class="c-content-block">
										...
										<span class="desc">Our Working Hours!</span>
									</span>
                        </a>
                    </div>
                    ...
                    <div class="c-link-box wow rollIn">
                        <a class="btn big-circle pull-left" href="#">
									<span class="c-content-block">
										...
										<span class="desc">Offer Friendly Service!</span>
									</span>
                        </a>
                    </div>
            ...
            <div class="row-1 ">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="section-title-box custom-5 wow rollIn center ">
                        <h2>Why Choose Us</h2>
                        <span>The Name you can Trust with Professional and Fully Trained Operators!</span>
                    </div>
                </div>
            </div>
            <div class="row-1">
                <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12 hidden-xs hidden-sm im-box">
                    <img class="content-left-image" alt="girl" src="media/home/girl.png">
                </div>
                ...
                <div class="row-footer">
                    <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12 wow fadeInLeft">
								<span class="copiright">
									Copyrights Garden Master 2015&nbsp; &bull; &nbsp;Designed By Templines
								</span>
                    </div>
...
<script src="<?php echo THEMEURL; ?>/plugins/switcher/js/bootstrap-select.js"></script>
<script src="<?php echo THEMEURL; ?>/plugins/switcher/js/evol.colorpicker.min.js" type="text/javascript"></script>
<script src="<?php echo THEMEURL; ?>/plugins/switcher/js/dmss.js"></script>

<script src="<?php echo THEMEURL; ?>/js/jquery-ui.min.js"></script>
<script src="<?php echo THEMEURL; ?>/js/modernizr.custom.js"></script>
<script src="<?php echo THEMEURL; ?>/js/smoothscroll.min.js"></script>
...
<!--Owl Carousel-->
<script src="<?php echo THEMEURL; ?>/plugins/owl-carousel/owl.carousel.min.js"></script>
<script src="<?php echo THEMEURL; ?>/plugins/ekko-lightbox/ekko-lightbox.min.js"></script>
<script src="<?php echo THEMEURL; ?>/js/waypoints.min.js"></script>
<script src="<?php echo THEMEURL; ?>/js/jquery.easypiechart.min.js"></script>
<script src="<?php echo THEMEURL; ?>/js/func.js"></script>
</body>
</html>